...
NUM_COLS = ["poss", "mp", "raptor_total", "pace_impact"]
CAT_COLS = []   # no hay categóricas en WAR
TARGET   = "war_class"

RANGES = {
    "poss":         (0, 9000),  # Posesiones por temporada
    "mp":           (0, 4500),  # Minutos por temporada
    "raptor_total": (-25, 25),  # Puntos/100 posesiones
    "pace_impact":  (-6, 6),    # Impacto por 48 min
}
...
def fit_preprocessor(train_df: pd.DataFrame):
    ...
    # one-hot sobre train para fijar columnas
    tmp = train_df.copy()
